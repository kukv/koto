    ...
    "verify_knowledge",
    {
      ...
      inputSchema: {
        ...
        note: z
          ...
          .min(1)
          .describe(
            "検証根拠。誰に何を確認したかを具体的に書く。記録に残る。既存の verified_note は置換されるため、残したい内容があれば引き継いで書くこと",
          ),
      },
    },
    async ({ id, level, note }) => {
