...
**将来計画・不確実な記述など、本文に反映すべきでない要確認事項も、最後の報告にまとめるだけで終わらせない。** 承認済み相手に使う `note` だけの `propose_update` は、こうした「本文には書けないが承認者には伝えたい」情報を届ける経路でもある。手順 5 の最終報告は投入した内容の要約であって、投入の代わりにはならない — 報告に書いただけでは koto にも次に読む人にも届かない。
